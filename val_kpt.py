...
def run(data,
    ...
    if len(stats) and stats[0].any():
        p, r, ap, f1, ap_class = ap_per_class(*stats, plot=plots, save_dir=save_dir, names=names, kpts=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/workspace/detection/edgeai-yolov5-yolo-pose/runs/train/exp4/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='/home/workspace/detection/edgeai-yolov5-yolo-pose/data/coco_kpts.yaml', help='*.data path')
    ...
    parser.add_argument('--kpt-label', action='store_true', help='Whether kpt-label is enabled or not', default=True)
